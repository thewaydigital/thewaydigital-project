...
general_query = "SELECT * FROM `spartan-cedar-337400.google_sheets.lasinoh_subscribers_complete_table` WHERE country_code = 'MX'"
...
if not df.empty:
    ...
    wks = sh.worksheet_by_title("Leads - MX")
