...
general_query = "SELECT * FROM `spartan-cedar-337400.google_sheets.lasinoh_subscribers_complete_table` WHERE country_code = 'AR'"
...
if not df.empty:
    ...
    wks = sh.worksheet_by_title("Leads - AR")
